<template>
  <main class="content">
    <section class="desk">
            ...
            <ul class="user-filter">
              <li class="user-filter__item" v-for="user in users" :key="user.id" :title="user.name">
                <a class="user-filter__button">
                  <img alt="Аватар юзера" width="24" height="24" :src="getImage(user.avatar)" />
                </a>
              </li>
            </ul>
          </div>
          <div class="desk__meta-filter">
            <ul class="meta-filter">
              <li v-for="({ value, label }) in STATUSES" :key="value" class="meta-filter__item">
                <a :class="`meta-filter__status meta-filter__status--color meta-filter__status--${value}`"
                  :title="label" />
              </li>
            </ul>
          </div>
      ...
      <p class="desk__emptiness" v-else>
